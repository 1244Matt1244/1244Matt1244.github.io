Sure! Here's the updated `README.md` that includes your full-stack PHP application with modern features:
...
```markdown
# Matej Martinović - Software Engineer

![Matej Martinović](https://via.placeholder.com/200x200.png?text=Matej+Martinovi%C4%87)  
**A passionate and versatile software engineer** with experience in both frontend and backend development, cloud infrastructures, and DevOps practices. I thrive in dynamic environments, tackling real-world challenges and creating innovative solutions.
...
![maze_escape](https://via.placeholder.com/200x150.png?text=Maze+Escape)
...
![openstack_terraform_generator](https://via.placeholder.com/200x150.png?text=OpenStack+Terraform)
...
![azure_project](https://via.placeholder.com/200x150.png?text=Azure+Project)
...
![qrcode_generator](https://via.placeholder.com/200x150.png?text=QR+Code+Generator)

---

### 5. **[rest_api](https://github.com/1244Matt1244/rest_api)**
**Backend:** TypeScript | Node.js | Fastify | TypeORM  
A REST API built using Fastify for managing user accounts and delivering metrics.

![rest_api](https://via.placeholder.com/200x150.png?text=REST+API)
...
![ha-master-slave-setup](https://via.placeholder.com/200x150.png?text=Redis+Setup)
...
![qgis_project_python](https://via.placeholder.com/200x150.png?text=QGIS+Project)
...
![bank_system_ERP](https://via.placeholder.com/200x150.png?text=Bank+System+ERP)
...
![credit_card_fraud_detection](https://via.placeholder.com/200x150.png?text=Fraud+Detection)
...
![small_guestbook_application](https://via.placeholder.com/200x150.png?text=Guestbook+Application)
...
![backend_service_assignment](https://via.placeholder.com/200x150.png?text=Backend+Service)
...
![sql_learning_materials_scripts](https://via.placeholder.com/200x150.png?text=SQL+Learning)
...
![enhanced_python-code_with_turtle_graphics](https://via.placeholder.com/200x150.png?text=Python+Graphics)
...
![character_frequency_counter](https://via.placeholder.com/200x150.png?text=Character+Frequency)
...
![python_geometrical_task](https://via.placeholder.com/200x150.png?text=Geometrical+Task)
...
![password_generator](https://via.placeholder.com/200x150.png?text=Password+Generator)
...
![quiz_game](https://via.placeholder.com/200x150.png?text=Quiz+Game)
...
![hello_fastify](https://via.placeholder.com/200x150.png?text=Fastify+App)

---

### 19. **[php_app](https://github.com/1244Matt1244/php_app)**
**Full Stack:** PHP | MySQL  
A full-stack PHP application featuring modern functionalities such as user authentication, input validation, and database interaction, built with MySQL.

![php_app](https://via.placeholder.com/200x150.png?text=PHP+App)
...
📩 [matt123.3a@gmail.com](mailto:matt123.3a@gmail.com)

Connect with me on LinkedIn:  
🔗 [Matej Martinović](https://www.linkedin.com/in/matejmartinovic)
